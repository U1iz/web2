...
(function () {
    ...
    let external = '::selection { background-color: rgba(181, 212, 226, 0.24) !important; color: rgba(255, 255, 255, 0.72) !important; } code::selection { background:rgba(245, 198, 205, 0.72); /* color:rgba(255, 255, 255, 0.72); */ color: rgba(160, 193, 118, 0.96) !important; }'
    ...
    let cur = ' * { /* cursor: url(https://files-cdn.cnblogs.com/files/miluluyo/cursor.ico),auto; */ /* 指针来源自: https://zhutix.com/ico/simplify-mint-cuu */ cursor: url(http://96yzl.usa3v.vip/HTML/project/Unity/rsc/img/ico/default.cur), default !important; } a { cursor: url(http://96yzl.usa3v.vip/HTML/project/Unity/rsc/img/ico/pointer.cur), pointer !important; }';
