...
if (sessionStorage.getItem('fileDate' + "220314") == "220314") {} else {
    execute();
    sessionStorage.setItem('fileDate' + "220314", "220314");
    window.addEventListener('load', function () {
        sessionStorage.removeItem('fileDate' + "220314");
    });
}

function call(fileDate) {
    tit('单选 * 50', fileDate, 1);
