(function () {
    ...
    sessionStorage.setItem('randomNum', 'd1o2u3b4l7e_' + ((Math.random() + 137) / 33) * 1023 + ((Math.random() + 996) / 211) + 37 * ((Math.random() + 113) / 17));
    var browser = {
        versions: function () {
...
function addStr2Url(key, value) {
    ...
    if (window.location.href.slice(window.location.href.length - l) == key + '=' + value) {
