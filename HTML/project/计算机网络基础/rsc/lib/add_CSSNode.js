...
(function () {
    ...
    let external = 'li{font-weight: 400;color: #cb724c; text-shadow: 0.06rem 0.06rem 0.12rem #ccc;}body{background-color: #fff;}br::selection { background-color: transparent; }'
